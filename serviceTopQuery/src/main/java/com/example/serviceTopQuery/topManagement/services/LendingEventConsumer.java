...
public class LendingEventConsumer {
    ...
    public LendingEventConsumer(TopServiceImpl topService, LendingRepository lendingRepository) {
    ...
    public void handleLendingCreatedEvent(LendingDTO lendingDTO) {
        ...
        boolean lendingExists = topService.lendingExists(lendingDTO.getLendingCode());
